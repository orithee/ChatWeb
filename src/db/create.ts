...
export async function createUser(user: Register) {
  /* Create a new user:
     If the query succeeds, it will return the user. If it fails, it will return undefined. */
...
export async function createGroup(group: CreateNewGroup) {
  /* Create a new group:
     If the query succeeds, it will return the group. If it fails, it will return undefined. */
